    ...
    startTimer() {
        if (!this.timerEvent) {
            try{
                ...
                console.log(this);
                console.log("what a loser. ^^^ doesn't know what a scene is (old instance that is still listening to old events, got this here so that two seconds don't pass in one)")
            }
